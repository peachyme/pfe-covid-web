    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modal-content-bg">
            ...
            <div class="modal-body px-5 pb-4 pt-1">
                <form action="{{route('CMT.vaccination.reporting')}}" method="GET">
                    <div class="mb-2">
                        <label for="cmt" class="form-label fw-bold">CMT :</label>
                        <select name="cmt" id="cmt" class="form-select form-control form-control-custom" aria-label="Default select example">
