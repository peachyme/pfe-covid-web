        ...
        <div class="justify-content-center mx-4">
            ...
            <div class="card card-custom mb-4 mt-4">
                <div class="card-body pb-1">
                    <form action="{{ route('CMT.covid') }}" method="GET">
                        <div class="row">
                            <div class="col-2">
            ...
            <div class="row">
                <div class="col">
                    <a href="{{route('CMT.covid.reporting_quotidien')}}" class="btn btn-dark-no-radius"><i class="fa-solid fa-file-pdf me-2"></i>Générer Reporting Quotidien 3CMT</a>
                </div>
                <div class="col">
            ...
            @include('CMT.covid.generateReporting')
        </div>
    </div>
</div>
@endsection
