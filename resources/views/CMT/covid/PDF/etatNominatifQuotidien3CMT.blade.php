...
<body>
    ...
    <div class="text-center bg-light py-2 mb-4">
        <strong>REPORTING COVID-19 QUOTIDIEN DU {{date('d-m-Y', strtotime($date));}} DU CMT-DP/Siège</strong>
    </div>
    ...
    <div class="text-center bg-light py-2 mb-4"  style="page-break-before: always;">
        <strong>REPORTING COVID-19 QUOTIDIEN DU {{date('d-m-Y', strtotime($date));}} DU CMT-DP/Oued S'Mar</strong>
    </div>
    <table class="table table-hover table-bordered">
        <thead>
            <tr>
    ...
    <div class="text-center bg-light py-2 mb-4" style="page-break-before: always;">
        <strong>REPORTING COVID-19 QUOTIDIEN DU {{date('d-m-Y', strtotime($date));}} DU CMT-DP/Rue de Sahara</strong>
    </div>
    <table class="table table-hover table-bordered">
        <thead>
            <tr>
