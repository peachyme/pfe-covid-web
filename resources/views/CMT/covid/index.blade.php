...
<div class="main-container d-flex">
    ...
    <div class="content">
        <div class="text-gray ps-5 pt-3 pb-2 mb-3 bg-custom-dark">
            <h4>Etat nominatif des cas COVID-19 @if($today != 0) du {{$today}} @endif du CMT-{{ auth()->user()->region_cmt }}</h4>
        </div>
                                ...
                                @foreach ($consultations as $consultation)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('CMT.consultations.show', $consultation) }}" class="text-orange me-1"><i class="fa-solid fa-eye"></i></a>
                                        ...
                                        @include('CMT.covid.deleteConsultation')
                                    </tr>
                                @endforeach
                            @else
