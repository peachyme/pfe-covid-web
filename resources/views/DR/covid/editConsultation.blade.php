    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content modal-content-bg">
            ...
            <div class="modal-body card-custom pt-1">
                <form action="{{ route('DR.consultations.update', $consultation) }}" method="POST"  class="needs-validation border border-secondary rounded p-4 pt-0 mt-2 mb-1" novalidate>
                    @csrf
                    @method('PATCH')
                    <!-- Progress bar -->
                    <div class="progressbar">
                        ...
                        <div class="progress-step" data-title="Diagnostique"></div>
                    ...
                    <div class="form-step">
                        <div class="custom-input-group mb-5">
                            ...
                            <select name="modalite_priseEnCharge" class="form-select form-control form-control-custom" aria-label="Default select example" required>
                                ...
                                <option value="BDV" @if($consultation->modalités_priseEnCharge == 'BDV') selected @endif>Confinement Base de vie</option>
                        ...
                        <div class="custom-input-group mb-4">
                            ...
                            <select name="zone" class="form-select form-control form-control-custom" aria-label="Default select example">
                                <option hidden selected value="">Non confinée dans une zone</option>
                                <option value="">Non confinée dans une zone</option>
                                @foreach ($zones as $zone)
                                    <option value="{{ $zone->id }}" @if($consultation->zone_id == $zone->id) selected @endif>{{ $zone->code_zone }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-step">
                        ...
                        <div class="custom-input-group">
                            ...
                            <textarea class="form-control form-control-custom" id="observation" name="observation" rows="6" placeholder="observations..." style="resize: none;">{{$consultation->observation}}</textarea>
                        </div>
