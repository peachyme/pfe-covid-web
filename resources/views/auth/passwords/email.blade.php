                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="row mb-4 px-3">
                            <div class="input-group">
                                ...
                                <input id="email" type="email" class="form-control custom-form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="email" autofocus>
