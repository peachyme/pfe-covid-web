...
<div class="main-container d-flex">
    ...
    <div class="content">
        <div class="text-gray ps-5 pt-3 pb-2 mb-3 bg-custom-dark">
            <h4>Etat nominatif de l'opération de vaccination @if($today != 0) du {{$today}} @endif du CMT-{{ auth()->user()->region_cmt }}</h4>
        </div>
                            ...
                            @if (count($vaccinations) > 0)
                                @foreach ($vaccinations as $vaccination)
                                    <tr>
                                        ...
                                        @include('CMT.vaccination.editVaccination')
                                        @include('CMT.vaccination.deleteVaccination')
                                    </tr>
                                @endforeach
                            @else
