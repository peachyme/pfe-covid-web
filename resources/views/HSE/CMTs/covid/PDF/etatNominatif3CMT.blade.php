...
<head>
    ...
    <title>REPORTING 3CMT COVID-19</title>
...
<body>
    ...
    <div class="text-center bg-light py-2 mb-4">
        <strong>REPORTING <span style="text-transform: uppercase ;">{{$code}}</span> COVID-19 DES 3 CMT</strong>
    </div>
    <table class="table table-hover table-bordered text-center">
        ...
        <tbody>
            <tr>
                <th scope="row">CMT-DP/Siège</th>
                <td>{{$consultations_siege_pos}}</td>
                <td>{{$consultations_siege_gueris}}</td>
                <td>{{$consultations_siege_conf}}</td>
                <td>{{$consultations_siege_hosp}}</td>
                <td>{{$consultations_siege_deces}}</td>
                <td><strong>{{count($consultations_siege)}}</strong></td>
            </tr>
            <tr>
                <th scope="row">CMT-DP/Oued S'Mar</th>
                <td>{{$consultations_os_pos}}</td>
                <td>{{$consultations_os_gueris}}</td>
                <td>{{$consultations_os_conf}}</td>
                <td>{{$consultations_os_hosp}}</td>
                <td>{{$consultations_os_deces}}</td>
                <td><strong>{{count($consultations_os)}}</strong></td>
            </tr>
            <tr>
                <th scope="row">CMT-DP/Rue de Sahara</th>
                <td>{{$consultations_rds_pos}}</td>
                <td>{{$consultations_rds_gueris}}</td>
                <td>{{$consultations_rds_conf}}</td>
                <td>{{$consultations_rds_hosp}}</td>
                <td>{{$consultations_rds_deces}}</td>
                <td><strong>{{count($consultations_rds)}}</strong></td>
            </tr>
        </tbody>
    </table>
    ...
    <div class="text-center bg-light py-2 mb-4" style="page-break-before: always;">
        <strong>REPORTING <span style="text-transform: uppercase ;">{{$code}}</span> COVID-19 DU CMT-DP/Rue de Sahara</strong>
    </div>
    <table class="table table-hover table-bordered">
        <thead>
            <tr>
