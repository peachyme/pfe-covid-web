...
<div class="main-container d-flex">
    ...
    <div class="content">
        <div class="text-gray ps-5 pt-3 pb-2 mb-3 bg-custom-dark">
            <h4>{{$situation}}Etat nominatif de vaccination</h4>
        </div>
        <div class="justify-content-center mx-4">
            ...
            <div class="card card-custom mb-4 mt-4">
                <div class="card-body pb-1">
                    <form action="{{ route('CMT.vaccination') }}" method="GET">
                        <div class="row">
                            <div class="col-2">
            ...
            <div class="row">
                <div class="col">
                    <a href="{{route('CMT.vaccination.reporting_hebdomadaire')}}" class="btn btn-dark-no-radius"><i class="fa-solid fa-file-pdf me-2"></i>Générer Reporting Hebdomadaire 3CMT</a>
                </div>
                <div class="col">
            ...
            @include('CMT.vaccination.generateReporting')
        </div>
    </div>
</div>
@endsection
