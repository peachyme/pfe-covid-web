        ...
        <div class="justify-content-center mx-4">
            ...
            <div class="card card-custom">
                            ...
                            <td colspan="6">
                                <table class="table table-bordered mb-0">
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        <tr>
                                            <td>Période de confinement : {{ $consultation->periode_confinement }} jours</td>
                                            <td>
                                                Zone de confinement :
                                                @if (empty($consultation->zone_id)) ___
                                                @else {{ $consultation->zone->code_zone }}
                                                @endif
                                            </td>
                                        </tr>
                                    </tbody>
                ...
                <div>
                    ...
                    @include('DR.covid.editConsultation')
                </div>
            </div>
            </div>
        </div>
